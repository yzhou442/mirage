...
// https://github.com/flashinfer-ai/flashinfer/blob/bbb57add5affe44e5df87ecd2c97656108ef1330/include/flashinfer/attention/hopper/kernel_traits.cuh
...
struct AttentionKernelTraits {
  ...
  // NOTE(Zihao): the following constant should only be used when TMA is
  // enabled, where only one warp inside a warp group is used for TMA.
  ...
  using SmemLayoutV = decltype(tile_to_shape(SmemLayoutAtomV{},
                                             make_shape(get<2>(TileShape_PDV{}),
                                                        get<1>(TileShape_PDV{}),
                                                        Int<NUM_STAGES>{})));
  ...
  using SmemLayoutVt = decltype(composition(
      SmemLayoutV{},
      make_ordered_layout(make_shape(get<1>(TileShape_PDV{}),
                                     get<2>(TileShape_PDV{}),
                                     Int<NUM_STAGES>{}),
                          Step<_2, _1, _3>{})));
